...
export default function RegisterPage() {
  ...
  return (
    <div className="min-h-screen flex">
      {/* Left Side - Branding */}
      <div className="hidden lg:flex lg:w-1/2 bg-gradient-to-br from-theme-primary via-theme-accent to-theme-primary p-12 items-center justify-center relative overflow-hidden">
        ...
        <div className="relative z-10 text-white max-w-md">
          ...
          <p className="text-pink-100 text-lg mb-8">
            Create an account to unlock exclusive deals and personalized shopping experience.
          </p>
          <div className="space-y-4">
            <div className="flex items-start space-x-3">
              ...
              <p className="text-pink-100">Exclusive member-only discounts</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="mt-1 bg-pink-500 rounded-full p-1">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-pink-100">Fast and secure checkout</p>
            </div>
            <div className="flex items-start space-x-3">
              <div className="mt-1 bg-pink-500 rounded-full p-1">
                <svg className="w-4 h-4" fill="currentColor" viewBox="0 0 20 20">
              ...
              <p className="text-pink-100">Order tracking and history</p>
            </div>
          </div>
        </div>
      </div>
        ...
        <div className="max-w-md w-full">
          ...
          <div className="bg-bg-primary rounded-2xl shadow-xl p-8 border border-border-color">
            ...
            <form onSubmit={handleSubmit} className="space-y-5">
              ...
              <FormField id="full_name" label="Full Name" required error={error || undefined}>
                <div className="relative">
                  ...
                  <input
                    ...
                    className="block w-full pl-10 pr-3 py-3 border border-border-color rounded-lg focus:ring-2 focus:ring-theme-primary focus:border-transparent transition duration-150 ease-in-out sm:text-sm bg-bg-primary text-text-primary"
                    placeholder="John Doe"
                    {...getFieldAria({ error: error || undefined }, 'full_name')}
                  />
                </div>
              </FormField>
              ...
              <FormField id="phone" label="Phone Number" required error={error || undefined}>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                  ...
                  <input
                    ...
                    {...getFieldAria({ error: error || undefined }, 'phone')}
                  />
                </div>
              </FormField>
              ...
              <FormField id="password" label="Password" required error={error || undefined}>
                <div className="relative">
                  ...
                  <input
                    ...
                    onChange={handleChange}
                    className="block w-full pl-10 pr-10 py-3 border border-border-color rounded-lg focus:ring-2 focus:ring-theme-primary focus:border-transparent transition duration-150 ease-in-out sm:text-sm bg-bg-primary text-text-primary"
              ...
              <FormField id="confirmPassword" label="Confirm Password" required error={error || undefined}>
                <div className="relative">
                  <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                    <Lock className="h-5 w-5 text-text-tertiary" />
                  </div>
                  <input
                    ...
                    {...getFieldAria({ error: error || undefined }, 'confirmPassword')}
                  />
                  <button
                    type="button"
            ...
            <div className="mt-6">
              <div className="relative">
                ...
                <div className="relative flex justify-center text-sm">
                  <span className="px-2 bg-bg-primary text-text-tertiary">Already have an account?</span>
                </div>
              </div>
              ...
              <div className="mt-6 text-center">
                <Link
                  ...
                  className="font-medium text-theme-primary hover:opacity-80 transition duration-150 ease-in-out"
                >
                  Sign in instead
                </Link>
              </div>
